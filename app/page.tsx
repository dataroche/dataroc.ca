  ...
  return (
    <section className="max-w-[600px]">
      ...
      <p className="my-5">
        ...
        explores the latency of different crypto exchanges and the relationship
        between the real-time prices of certain symbols.
      </p>
      ...
      <p>
        The avatar is named SOLeNOID and is the result of the creative genius of{' '}
        <a
