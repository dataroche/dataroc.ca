...
All the [dynamic content from my live portfolio](/crypto-bots) is served off a PostgREST
API. This post aims to summarize the different views currently exposed by the API and
