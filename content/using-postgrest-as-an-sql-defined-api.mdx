...
I recently discovered [PostgREST](https://postgrest.org/) and it's been quite a love
...
One note here. If you want the PostgREST server to pick-up on changes and clear it's
