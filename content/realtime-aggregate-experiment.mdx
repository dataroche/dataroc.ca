...
<img src="/images/realtime-aggregate/crv_usdt_binanceus_jumps.png" alt="CRV/USDT shows
how a low activity exchange has a trailing last price" />
<small>Notice how binanceus last price is static for long periods of time, and then
"corrects" itself to the mean of other exchanges at that moment.</small>
