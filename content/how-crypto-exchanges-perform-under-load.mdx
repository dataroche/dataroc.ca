...
<StaticPlotlyChart filepath='rae-part2/active_connectors.json'>
    Figure 1: Active connectors per symbol during the experiment length. 
    Each block is a connector that produced at least one message during an hour interval.
</StaticPlotlyChart>
...
literal *sound* indicator of market volatility is actually a good thing...
...
One interesting property of the database latency is that it *only* considers the
