...
summary: "Following the previous quick exploration and after much feedback, I'm extending the timestamp performance across Python versions and machine types."
---
