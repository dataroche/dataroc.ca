...
summary: 'Explore secure data writing with PostgREST API in this insightful post — essential tools powering updates on my dynamic portfolio page.'
tags: 
  - 'dataroc.ca'
  - 'sql'
  - 'python'
