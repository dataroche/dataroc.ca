...
summary: 'Learn how to securely write data to your PostgREST API endpoint from a Python script — Whether you host your own PostgREST endpoint, or use a service like Supabase.'
tags: 
  - 'dataroc.ca'
  - 'sql'
  - 'python'
...
PostgREST enables you to define secure API endpoints through SQL. Whether you have your
own PostgREST API running, or would like to update your Supabase data from an external
Python script, this post is for you!
...
`/api/latest_trades`, it must first exist in the database. Let's
...
the default `api_anon` role. The name of this role is not special; you simply need to
...
secure, writable endpoints. This tutorial marks the commencement of an exploration into
the extensive possibilities that lie ahead in your SQL and Python journey. Happy coding!
