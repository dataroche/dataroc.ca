...
<Callout emoji="👉">
[The next blog post](/blog/terraform-module-to-stream-pubsub-json-to-cloud-sql-on-gcp)
 introduces a Terraform module to automate the steps explained here!
</Callout>
...
<img
  src="/images/streaming-pubsub/pubsub_performance.png"
...
<img src="/images/streaming-pubsub/pubsub_backlog_performance.png" alt="The pull worker
  backlog-clearing performance" /> 
<small> 
